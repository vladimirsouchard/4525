...
1. [Setup - The basics of getting started with init](#setup)
    * [What init affects](#what-init-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with init](#beginning-with-init)
